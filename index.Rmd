...
pretty_tree_output <- function(output_table) {
	...
	output_table_clean$study_id <- paste0("<a href='../trees/tree_",output_table_clean$study_id, ".phy'>", "tree_",output_table_clean$study_id, ".phy</a>" )
